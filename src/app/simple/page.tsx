...
export default function Simple() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="css-loaded-test mb-4">
        🎨 CSS読み込みテスト - これがグラデーションなら成功
      </div>
      
      <div className="bg-blue-500 text-white p-4 mb-4 rounded">
        Tailwindテスト - この背景が青ければTailwind動作
      </div>
      <div className="test-red mb-4 rounded">
        CSS クラステスト - 赤い背景
      </div>
      
      {/* より強力なTailwindテスト */}
      <div className="bg-green-500 text-white p-6 mb-4 rounded-lg shadow-lg">
        🟢 Tailwind緑テスト（影付き）
      </div>
