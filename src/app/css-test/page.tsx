      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-purple-500 text-white p-4 rounded text-center font-bold">
              Purple 500
            </div>
            <div className="bg-yellow-500 text-black p-4 rounded text-center font-bold">
              Yellow 500
            </div>
            <div className="bg-pink-500 text-white p-4 rounded text-center font-bold">
              Pink 500
            </div>
            <div className="bg-indigo-500 text-white p-4 rounded text-center font-bold">
              Indigo 500
            </div>
            <div className="bg-gray-500 text-white p-4 rounded text-center font-bold">
              Gray 500
            </div>
          </div>
        </section>
