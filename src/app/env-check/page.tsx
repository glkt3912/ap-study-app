      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span>
                  {'serviceWorker' in navigator ? '✅ サポート' : '❌ 非サポート'}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-gray-800 text-green-400 p-6 rounded-lg font-mono text-sm">
          ...
          <div className="space-y-2">
            <div>キャッシュクリア: <code className="bg-gray-700 px-2 py-1 rounded">rm -rf .next && npm run build</code></div>
            <div>依存関係更新: <code className="bg-gray-700 px-2 py-1 rounded">npm install</code></div>
            <div>開発サーバー: <code className="bg-gray-700 px-2 py-1 rounded">npm run dev</code></div>
            <div>ビルドテスト: <code className="bg-gray-700 px-2 py-1 rounded">npm run build</code></div>
          </div>
        </div>
